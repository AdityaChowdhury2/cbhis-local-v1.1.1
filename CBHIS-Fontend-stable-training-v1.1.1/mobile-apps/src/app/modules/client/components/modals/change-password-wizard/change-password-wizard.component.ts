...
@Component({
  selector: 'app-change-password-wizard',
  templateUrl: './change-password-wizard.component.html',
  styleUrls: ['./change-password-wizard.component.scss'],
})
export class ChangePasswordWizardComponent implements OnInit {
